                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              const SizedBox(height: 8),
                              const Text(
                                'Run the first-time tutorial again on this account.',
                              ),
                              const SizedBox(height: 12),
                              SizedBox(
                                key: tutorialTargets?.settingsReactivate,
                                width: double.infinity,
                                child: OutlinedButton.icon(
                                  onPressed: () {
                                    appState.restartTutorialForDebug();
                                    Navigator.popUntil(
                                      context,
                                  ...
                                  label: const Text('Reactivate tutorial'),
                                ),
                              ),
                            ],
                          ),
...
void _handleSettingsTutorialPrimary(SpiralAppState appState) {
  if (!kDebugMode && appState.tutorialStep == TutorialStep.settingsDifficulty) {
    appState.setTutorialStep(TutorialStep.finish);
    return;
  }
